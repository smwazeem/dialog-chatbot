...
class ChatWindow extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      height: 0,
      token: '',
      URL: 'https://www.finatar.com:444/send',
      message: '',
      partial: '',
      sendersList: ['Hello'],
      listening: false,
  ...
  componentDidMount() {
    this.injectJS(this.state.initmsg);
  ...
  msgRenderer(isSenders, message) {
    ...
    if (isSenders) {
      ...
      mainContainer.setAttribute("class", "form-inline");
      let messageDiv = document.createElement('div');
      messageDiv.setAttribute('style', "width:200px;color:white;border-radius:5px;background-color:#7a7a7a;opacity:0.7;margin-left:75px;margin-top:10px;margin-bottom:10px;")
      ...
      if (message.includes("https")) {
        ...
        mainContainer.setAttribute("class", "form-inline");
        let messageDiv = document.createElement('div');
        messageDiv.setAttribute('style', "width:200px;color:white;border-radius:5px;background-color:black;opacity:0.7;margin-right:10px;margin-top:10px;margin-bottom:10px;")
    ...
    return (
      <div>
        ...
        <div style={{ float: 'left', clear: 'both' }}>
          <iframe id={"aWin"} allow={"autoplay"} style={style.iframe} onLoad={() => { this.injectJS(this.state.initmsg) }} title="Hi, I'm Thanuja" width="300" height="500"></iframe>
        </div>
        <Hints />
